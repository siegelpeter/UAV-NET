...
namespace ColorProgressBar
{
	...
	{	
		...
		protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
		{
			...
			// Check for value
			//
			if (_Maximum == _Minimum || (_Value+offset) == 0)
			{
            ...
            if (_Minimum < 0) offset = _Minimum*-1;
			//
			// The following is the width of the bar. This will vary with each value.
			//
			int fillWidth = Convert.ToInt32((this.Width * (_Value+offset)) / ((_Maximum+offset) - (_Minimum+offset)));
